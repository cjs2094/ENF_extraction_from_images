function [enf_true, sinusoidalPartEnf_true, x_true, entropy_raw_total] = func_getTrueEnfAndEntropy(Fe_true, T_row, m_s, m_t, results, col_idx_set, num_of_col_to_use)
...
for jjj = 1 : num_of_col_to_use
    entropy_raw_arr(jjj) = func_computeEntropy(col_residue(:, jjj), pel_level_range);
end
