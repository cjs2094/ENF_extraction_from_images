function func_testSynImgsBatch(img_db_path, mat_file_base_name, save_mat_flag, fitting_results_flag, colSelect_mode, repeat_times, results, fitting_results_decided, num_of_col_to_use)
...
for i = 1 : img_cnt
    for idx_repeat = 1 : repeat_times
        ...
        if ~skip_flag
            ...
            %%%%%%%%%%%%%%%% Error metrics %%%%%%%%%%%%%%%%
            corr_curve = func_calcPearsonCorr(sinusoidalPartEnf_true, sinusoidalPartEnf_fit);
            ...
            if j_decided ~= 3
                ...
                %                 func_performFigurativeComp_syn(img_gray, img_size, region, lim, mRange, enf_true, x_true, Fe_true, Fe_hat_curve, Fe_hat_entropy,...
                %                     img_residue_curveFitting, sinusoidalPartEnf_true, sinusoidalPartEnf_fit, sinusoidalPartEnf_entropy, Iavg, trend_fit,...
        ...
        if save_mat_flag
            save(['mat_results_syn/' output_mat_fn], 'test_results');
