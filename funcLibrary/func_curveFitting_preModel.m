function [fitting_results_all, ind_for_fitting_results_all] = func_curveFitting_preModel...
...
for ind_for_Fe = 1 : length(ENF_arr)
    ...
    for ind_for_bound_flag = 1 : length(bound_flag_arr)
        ...
        [fitresult, gof1] = func_myFit_preModel(mRange, I, Fe_set, T_row, bound_flag);
