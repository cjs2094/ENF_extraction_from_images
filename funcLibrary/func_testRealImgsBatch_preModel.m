function func_testRealImgsBatch_preModel(img_db_path, mat_file_base_name, save_mat_flag, fitting_results_flag, colSelect_mode, repeat_times, fitting_results_decided, num_of_col_to_use)
...
for i = 1 : img_cnt   
    for idx_repeat = 1 : repeat_times      
        ...
        mRange = m_s : m_t;
        ISet = img_gray(mRange, col_idx_set);
        
        fun_100 = @(x) func_entropyCol_preModel(img_gray, mRange, col_idx_set, T_row, 100, x(1), x(2));
        fun_120 = @(x) func_entropyCol_preModel(img_gray, mRange, col_idx_set, T_row, 120, x(1), x(2));
        ...
        if ~skip_flag
            ...
            [~, Iavg, sinusoidalPartEnf_fit, trend_fit, error_fit]...
                = func_estimateENFAndEntropyUsingFittingResults_preModel(img_gray, fitresult, Fe_hat_curve, T_row, m_s, m_t, col_idx_set, num_of_col_to_use);
            ...
            for i_par = 1 : 2
                ...
                if i_par == 1
                    ...
                    elseif fitting_results_flag == 0
                        ...
                        for lll = 1 : 6
                            [x0, LB, UB] = func_initForFminsearchbnd_preModel(lll);
            ...
            x_f100   = search_result_cell{1}(1 : 2); fval_100 = search_result_cell{1}(3);
            x_f120   = search_result_cell{2}(1 : 2); fval_120 = search_result_cell{2}(3);
            entropy_margin = abs(fval_100 - fval_120);
            
            disp('## estimates:')
            disp(sprintf('a = %.2f, phi = %.2f, obj = %.4f [100Hz]', x_f100(1), x_f100(2), fval_100));
            disp(sprintf('a = %.2f, phi = %.2f, obj = %.4f [120Hz]', x_f120(1), x_f120(2), fval_120));
            ...
            if fval_100 < fval_120
                ...
                [img_residue_entMini, sinusoidalPartEnf_entropy] = func_removeENFfromImg_preModel...
                    (img_gray, img_size, T_row, 100, m_s, m_t, x_f100(1), x_f100(2));
            elseif fval_100 > fval_120
                ...
                [img_residue_entMini, sinusoidalPartEnf_entropy] = func_removeENFfromImg_preModel...
                    (img_gray, img_size, T_row, 120, m_s, m_t, x_f120(1), x_f120(2));
            else
                disp('cannot decide.')
            end
            ...
            [img_residue_curveFitting, ~] = func_removeENFfromImg_preModel...
                    (img_gray, img_size, T_row, Fe_hat_curve, m_s, m_t, fitresult.a, fitresult.phi);
            ...
            if j_decided ~= 3
                ...
                img_file_name = ['./fig_results_preModel/' output_img_fn1 '.png'];
                ...
                img_file_name = ['./fig_results_preModel/' output_img_fn1 '.fig'];
                saveas(h, img_file_name);
        ...
        if save_mat_flag
            save(['./matResults_preModel/' output_mat_fn], 'test_results');
