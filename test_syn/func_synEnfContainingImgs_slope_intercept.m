function [enfContainingImages, enfSignals, trueParameters] = func_synEnfContainingImgs_slope_intercept(imgPath, T_row, relativeStr, absoluteStr, phase0Cnt, ENF_arr)
...
for i = 1 : imgCnt
    ...
    bestChannel = uint8(0.5*extractBestChannel_PCA(img_rgb));
...
for iii = 1 : phase0Cnt
    ...
    for ii = 1 : length(ENF_arr)
        ...
        for i = 1 : imgCnt
            ...
            [img_syn, trueParam] = synEnfContainingImg_VAVB_slope_intercept(img_cell{i}, param);
            %img_syn = func_synEnfContainingImg(img_rgb, param);
