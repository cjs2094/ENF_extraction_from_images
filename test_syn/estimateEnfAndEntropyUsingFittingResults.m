function [entropy_est_total, Iavg, sinusoidalPartEnf_fit, trend_fit, error_fit] = estimateEnfAndEntropyUsingFittingResults...
...
for jjj = 1 : num_of_col_to_use
    entropy_est_arr(jjj) = computeEntropy(col_residue(:,jjj), pel_level_range);
end
