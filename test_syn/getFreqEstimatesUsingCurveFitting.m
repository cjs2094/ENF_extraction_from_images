function getFreqEstimatesUsingCurveFitting(save_mat_flag, mat_file_name, img_db_path, colSelect_mode, num_of_col_to_use, repeat_times)
...
fitting_results_decided = {'img_file_location', 'Fe_set', 'bound_flag', 'fitresult',...
    'rmse_100Hz', 'rmse_120Hz', 'Fe_true', 'Fe_hat_curve', 'col_idx_set', 'mRange: [m_s, m_t]'};
...
for i = 1 : img_cnt
    for idx_repeat = 1 : repeat_times
        ...
        elseif isequal(colSelect_mode, 'colRandOnSmooth') % random column index set from only smooth region
            ...
            [col_idx_set] = colSelectFromSelectedRegion(img_region_coordinates, num_of_col_to_use); 
        ...
        %% curve fitting
        [fitting_results_all, ind_for_fitting_results_all] = curveFitting...
        ...
        cell_temp = [fitting_results_all(ind_temp, 1:4), rmse_100Hz, rmse_120Hz, ...
            Fe_true, Fe_hat_curve, col_idx_set, [m_s, m_t]];
