function entropy_estRaw_total = objective_imgEntropyCol_VAVB_two_point(img, imgSize, colIdxSet, T_row, frequency, a_s, a_t, b_s, b_t, phi)
...
trend = ((b_t - b_s)/(imgSize(1)-1)*yRange + b_s);
