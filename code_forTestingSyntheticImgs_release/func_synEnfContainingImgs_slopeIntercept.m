function [enfContainingImages, enfSignals, trueParameters] = func_synEnfContainingImgs_slopeIntercept(imgPath, T_row, relativeStr, absoluteStr, phase0Cnt, ENF_arr)
...
for iii = 1 : phase0Cnt
    ...
    for ii = 1 : length(ENF_arr)
        ...
        for i = 1 : imgCnt
            ...
            [img_syn, trueParam] = func_addSynEnfToImg_specialCase_slopeIntercept(img_cell{i}, param);
