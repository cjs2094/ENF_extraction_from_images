...
func_draw1stRocCurves_syn(mat_file_base_name1, mat_file_base_name2, fitting_results_flag,...
...
func_draw2ndRocCurves_syn(mat_file_base_name1, mat_file_base_name2, fitting_results_flag,...
