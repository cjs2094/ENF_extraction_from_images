...
for jjj = 1 : length(colSelect_mode_arr)
    ...
    for iii = [50 60]
        ...
        for num_of_col_to_use = 32 %[1 2 4 8 16 32 64 128]
            func_getFreqEstimatesUsingCurveFitting_syn(save_mat_flag, mat_file_name, img_db_path, colSelect_mode, num_of_col_to_use, repeat_times)
        end
    end
end
...
for jjj = 1 : length(colSelect_mode_arr)
    ...
    for iii = [50 60]
        ...
        for num_of_col_to_use = 32 %[1 2 4 8 16 32 64 128]
            ...
            func_testSynImgsBatch(img_db_path, mat_file_name, save_mat_flag, fitting_results_flag, colSelect_mode, repeat_times, results, fitting_results_decided, num_of_col_to_use)
        end
    end
end
