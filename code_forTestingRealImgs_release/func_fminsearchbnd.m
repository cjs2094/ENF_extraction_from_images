function [x,fval,exitflag,output] = func_fminsearchbnd(fun, x0, LB, UB, options, varargin)
% downloaded from: https://www.mathworks.com/matlabcentral/fileexchange/8277-fminsearchbnd-fminsearchcon
